  ...
  (unless (eobp)
	...
	(let* (;; when at block-start, be specific
		...
		(cond
		 ...
		 ;; look upward
		 (t (py--go-to-keyword regexp nil (if (and (member regexp (list 'py-block-re 'py-clause-re 'py-def-or-class-re 'py-def-re 'py-class-re)) (looking-at (symbol-value regexp))) '< '<=)))))
